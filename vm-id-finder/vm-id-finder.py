...
ap.add_argument(
    "-d", "--default", help="Use default admin/smartvm credentials", action="store_true"
)
ap.add_argument(
    "-p", "--provider", required=True, help="Use your vCenter provider name"
)
...
# error reporting
print "-----------------------------------------------------------------"
print "Following VMs not exists on '{0}' " "please check them manually!\n{1}".format(
    args["provider"], error
)
print "-----------------------------------------------------------------"
